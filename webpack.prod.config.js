...
const antdLessLoaders = [
    {
        loader: 'css-loader',
        options: {
            modules: false, // antd样式按需加载不支持CssModule
            discardComments: {removeAll: false},
        }
    },
    {
...
module.exports = {
    ...
    resolve: {
        extensions: ['.jsx', '.js'], // webpack 编译时自动补充后缀
        ...
        rules: [
            ...
            },
            {
                ...
                oneOf: [
                    {
                        test: /\.less$/,
                        include: [path.resolve(ROOT_PATH, 'node_modules/antd'), SRC_PATH],
                        use: [
    ...
    plugins: [
        ...
        //         },
        //         mangle: {
        //             keep_fnames: true // 不重命名，保持 React 开发者工具能查看到原始组件名
        //         },
        //     }
        // }),
        // 用于优化css文件
